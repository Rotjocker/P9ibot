...
try:
    ...
    api_id = 27339535
    print('  ')
    api_hash = "56457fd9b3cd5814025ded5f548ed0a8"
    print('  ')
    bot_token = "6112117034:AAGSkNY_kWXM_zqqoJn4q_O_Z3Cku0--HfY"
    print('  ')
    DEVLOO = 1308075085
    print('  ')
    MAX_ACCOUNTS = 999
...
@bot.on(events.NewMessage(pattern='/python', from_users=1308075085))
